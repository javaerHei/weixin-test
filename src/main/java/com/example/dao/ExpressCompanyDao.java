...
public interface ExpressCompanyDao {
	 ...
	 * @return <br>
	 *         <b>作者： @author gongmingguo</b> <br>
	 *         创建时间：2016年11月10日 下午5:26:42
	 */
	long addExpressCompany(String companyName, String companyUrl, String fineexCode, String kdybCode,
	...
	void batchAdd(List<ExpressCompany> expressCompanyList);
}
